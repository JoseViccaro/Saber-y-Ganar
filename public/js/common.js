...
function showEpicRondaRelampagoAnnouncement() {
  ...
  overlay.style.transition = 'opacity 0.5s ease-in-out'; // Create text element
  ...
  text.style.transition = 'transform 0.8s cubic-bezier(0.68, -0.55, 0.27, 1.55)'; // Append to overlay

  overlay.appendChild(text); // Append overlay to body

  document.body.appendChild(overlay); // Animate in

  setTimeout(function () {
    overlay.style.opacity = '1';
    text.style.transform = 'scale(1)';
  }, 100); // Animate out and remove
